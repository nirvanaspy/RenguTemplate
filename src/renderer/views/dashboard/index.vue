                    ...
                    <div class="col-md-6">
                        ...
                        <section class="tile transparent">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select data-placeholder="Select recipients..." multiple="" tabindex="3"
                                                    ...
                                                    id="message-to">
                                                <option value="http://tattek.com/minimal/ici@gmail.com">ici@gmail.com
                                                </option>
                                                <option value="http://tattek.com/minimal/johny@gmail.com">
                                                    johny@gmail.com
                                                </option>
                                                <option value="http://tattek.com/minimal/arnie@gmail.com">
                                                    arnie@gmail.com
                                                </option>
                                                <option value="http://tattek.com/minimal/pete@gmail.com">
                                                    pete@gmail.com
                                                </option>
                                                <option value="http://tattek.com/minimal/gorge@gmail.com">
                                                    gorge@gmail.com
                                                </option>
                                            </select>
                                        </div>
                            ...
                            <div class="tile-footer rounded-bottom-corners text-right">
                                <a class="submit font-slab" href="#"><strong>Send</strong> message <i
                                        class="fa fa-comment"></i></a>
                            </div>
                            <!-- /tile footer -->

                            Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a> - More
