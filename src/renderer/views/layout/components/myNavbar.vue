<template style="width: 100%">
  <div class="navbar navbar-default navbar-fixed-top navbar-transparent-black" style="width: 100%;padding: 0 20px">
    <div class="navbar-collapse" style="width: 100%">
      ...
      <ul class="nav navbar-nav quick-actions">
            ...
            <li>
              <a class="cyan" href="#">
                <div class="profile-photo">
                  &lt;!&ndash;<img src="assets/images/ici-avatar.jpg" alt />&ndash;&gt;
        ...
        <!--<li class="dropdown user" id="current-user">
          ...
          &lt;!&ndash;<ul class="dropdown-menu arrow settings">
      ...
      <el-dropdown class="nav navbar-nav quick-actions" trigger="click">
        <div class="avatar-wrapper" style="cursor: pointer">
          <img class="user-avatar" src="../../../assets/images/profile-photo.jpg" style="width: 40px;height: 40px;">
          <span>用户名</span>
