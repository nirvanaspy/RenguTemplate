var widthLess1024 = function () {
    if ($(window).width() < 1024) {
        $("#sidebar, #navbar, .main-container").addClass("collapsed");
        ...
        if ($("#sidebar").hasClass("collapsed")) {
            ...
            $("#content").animate({paddingLeft: "0"}, 150)
        }
    } else {
        $("#sidebar, #navbar, .main-container").removeClass("collapsed");
        if ($("#sidebar").hasClass("collapsed")) {
            $("#content").animate({left: "210px", paddingLeft: "0", marginLeft: '250px'}, 150)
        } else {
            $("#content").animate({paddingLeft: "0"}, 150)
        }
    }
    ...
    $(".sidebar-collapse a").on("click", function () {
        ...
        if ($("#sidebar").hasClass("collapsed")) {
            if ($(window).width() < 1024) {
                ...
                $("#content").animate({paddingLeft: "0", marginLeft: '250px'}, 150)
            }
        } else {
            if ($(window).width() < 1024) {
                $("#content").animate({left: "210px"}, 150)
            } else {
                $("#content").animate({paddingLeft: "0px"}, 150)
            }
        }
    });
